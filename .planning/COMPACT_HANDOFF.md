...
_Auto-generated by global PreCompact hook at 2026-08-10 05:03 UTC. Read first after compaction._

**Branch:** `main`
**HEAD:** `ce28de3`

## Last 20 commits
- ce28de3 agents: make codex and codex-audit thin GPT dispatchers, not Sonnet builders
- 3681ca3 hooks: block general-purpose and Explore spawns, force the codex route
- 27f2db4 guards: close the stash and inline-interpreter holes; add 4 audits
- 158c5e8 audit: measure per-component impact, not usage; cut SKILL.md 15.5K -> 9.3K
- 347a5e6 install: drop the dead codebase-first steps, stop the template resurrecting repowise
- be3ea8d harness: auto-inject the floor at SessionStart so /awesomeharness is optional
- f6cefe5 harness: cut contract-nudge, keep the six hooks that proved alive, fill Vividlist FRONT_DOOR
- cd65482 harness: remove the repowise MCP, keep the CLI for c5-dead and c7-preship
- 57b2625 harness: retire the false graphify import-graph ban; measure repowise MCP at 23 calls/30d in one repo
