...
_Auto-generated by global PreCompact hook at 2026-08-04 06:19 UTC. Read first after compaction._
...
- 5a3d5ce harness: Edit is the standing builder rule; codex exec is now opt-in
- 0f029bd state: resume point after the second loose-cable wave
- e1c8b1b harness: builders were not choosing Edit over codex exec, the sandbox was rejecting them
- 08a639e harness: the weekly launchd job stops reporting success while producing nothing; auditor bakeoff measured
- 2d4f804 harness: irreversible-pause command-matches instead of mention-matches; drop the dead BUILDER_FENCE toggle
